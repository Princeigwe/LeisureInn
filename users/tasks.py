...
app = Celery(app="LeisureInn", broker="amqp://guest:guest@rabbitmq:5672/") # app is the name of the project, broker is the url of the message broker (for development)
